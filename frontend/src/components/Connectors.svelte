...
{#if mode === "list"}
  <div class="flex flex-col gap-4">
    ...
    <p class="text-xs leading-relaxed text-zinc-400">Connectors apply to every bot; a choice per bot is planned. Keys and tokens are stored inside the Space, where the bots can read them anyway.</p>
  </div>
