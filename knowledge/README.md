...
| Design | [design/working-view.md](design/working-view.md) | **In progress** (steps 1 and 2 built 2026-09-08): what the chat shows while a bot works – steps folded into one line, a live line in the user's language, thinking live only |
